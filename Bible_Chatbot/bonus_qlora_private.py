...
import argparse
from transformers import T5Tokenizer, MT5ForConditionalGeneration, AutoConfig
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        help="Path to the pretrain of model."
    )
    parser.add_argument(
        "--peft_path",
        type=str,
    ...
    parser.add_argument(
        "--output_data_path",
        type=str,
        default="'./output_bonus_result_private_qlora.json'",
        required=False,
