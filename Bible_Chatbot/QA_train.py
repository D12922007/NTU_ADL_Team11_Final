...
parser.add_argument(
    "--model_name_or_path",
    type=str,
    default='hfl/chinese-macbert-large',#'hfl/chinese-macbert-large', #'hfl/chinese-macbert-large',  #'FlagAlpha/Llama2-Chinese-13b-Chat',#'hfl/chinese-macbert-large', #'hfl/chinese-bert-wwm', #'hfl/chinese-roberta-wwm-ext'
...
def Train_Q2():
    ...
    total_train_acc =  train_acc / step
...
if __name__ == '__main__':
    ...
    #tokenizer = BertTokenizerFast.from_pretrained(args.tokenizer_name, do_lower_case=False)
    ...
    plt.savefig('valid_pos_acc.png')
    plt.close()
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    plt.plot(ep, total_valid_par_acc_lst, 'g-o')
    plt.savefig('valid_par_acc.png')
    plt.close()
